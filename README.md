...
Releases
--------
The current release is version 1.0.0, available via http://builds.planet-xp.net/xp-forge/mustache/1.0.0/xp-mustache-1.0.0.xar. As long as [RFC 0267](https://github.com/xp-framework/rfc/issues/267) has not been implemented yet, you also need https://github.com/xp-forge/mustache/blob/master/lib/rfc-267.xar in your class path.
